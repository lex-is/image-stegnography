...
{
    public partial class FrmImCryption : Form
    {
        public FrmImCryption()
        {
            InitializeComponent();
        }
        ...
        {
            System.Diagnostics.Process.Start("http:\\\\codeonlinux.blogspot.com");

        }

        private void FrmImCryption_Load(object sender, EventArgs e)
        {
            MessageBox.Show("Tips:" + "\n" + "1. Use Large Size Image For Larger Documents"+"\n"+"2. Always Use High Quality Images For Better Output"+"\n"+"3. See Current Status In Bottom Left Corner");
        }
